...
lazy_static!{
    static ref SYSTEM_PARTITION_TYPES: HashSet<[u8; 16]> = [
        ...
        uuid_to_guid(hex!("6b636168 7420 6568 2070 6c616e657421")), // BOOT
        uuid_to_guid(hex!("5526016a 1a97 4ea4 b39a b7c8c6ca4502")), // ROOT
        uuid_to_guid(hex!("598f10af c955 4456 6a99 7720068a6cea")), // HASH
        uuid_to_guid(hex!("0c5d99a5 d331 4147 baef 08e2b855bdc9")), // RESERVED
        uuid_to_guid(hex!("440408bb eb0b 4328 a6e5 a29038fad706")), // PRIVATE
        uuid_to_guid(hex!("626f7474 6c65 6474 6861 726d61726b73")), // DATA
    ].iter().copied().collect();
}
